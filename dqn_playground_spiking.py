...
experiment_dir = os.path.abspath("./snn/robustness/"+str(occlusionloc)+"/{}".format(environment.env.spec.id))
...
np.savetxt('analysis/rewards_snn_tdg_robustness_'+str(occlusionloc)+'.txt', episode_rewards)

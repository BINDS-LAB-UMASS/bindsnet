...
parser.add_argument('@@layer1scale', dest='layer1scale', type=float, default=10)
parser.add_argument('@@layer2scale', dest='layer2scale', type=float, default=100)
...
experiment_dir = os.path.abspath("./snn/benchmark/{}".format(environment.env.spec.id))
